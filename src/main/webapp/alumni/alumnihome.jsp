			...
			<div class="container">
				<div class="hero-text-content">
					...
					<h2>Alumni Connect – Stay Inspired, Grow Together</h2>
						...
						<div class="hero-btn">
									<a href="events.jsp">
    <button class="btn login-btn px-5 fs-4" type="button">Events</button>
</a>
<a href="jobs.jsp">
    <button class="btn login-btn  fs-4 px-5" type="button">Jobs</button>
</a></div>
					</div>
				</div>
				<div class="hero-img">
					<img
						src="../images/alumnihero.svg"
						alt="">
				</div>
		...
		<%@include file="alumniComponents/memories.jsp"%>
