...
<div class="alumni-filter d-flex gap-5 fs-5 ">
              ...
              <select name="batch" id="courses">
               ...
               <select name="batch" id="courses">
                ...
                <option value="JEE/NEET">Company</option>
  ...
  <c:if test="${not empty alumniList}">
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <div class="card rounded">
                                <div class="el-card-item">
                                    <div class="el-card-avatar el-overlay-1 "> <img class=""rounded src="${alumni.profile_img }" alt="user">
    ...
    <i class='bx bxs-badge-check'></i>
										...
										<div class="d-flex justify-content-center gap-3">
											 <button type="button" class="btn google-btn  mx-0 my-1 px-3 py-1 "><a href="${alumni.linkdnLink }" class="text-decoration-none" style="color:inherit;"><i class='bx bxl-linkedin-square px-1'></i>Linkdn</a></button>
      										  <button type="button" class="btn google-btn  mx-0 my-1 px-3 py-1 "><a href="${alumni.githubLink }" class="text-decoration-none" style="color:inherit;"><i class='bx bxl-github px-1' ></i>Github</a></button>
