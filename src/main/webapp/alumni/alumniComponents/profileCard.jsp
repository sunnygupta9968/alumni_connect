    ...
    <i class='bx bxs-badge-check'></i>
      ...
      <div class="col-lg-8 ">
        ...
        <div class="card mb-4 border">
         <div class="container workExp-container py-5 ">
...
<%} %>
  ...
  <div class="d-flex justify-content-center">
        <a class="btn google-btn w-25 mx-4 text-decoration-none " href="editProfile.jsp"  >Edit Profile</a>
        <a class="btn google-btn w-25 mx-4 text-decoration-none " href="addExperience.jsp" >Update Exprience</a>
