...
<!-- Button -->
     ...
     <div class="login-form w-50">
          ...
          <div  class="login-form event-form">
            <h5 style="text-align: center; margin: 10px 0px; font-size: 18px;">Add a College Event</h5>
             <label for="eventTitle">Event Title* :</label>
              <input type="text" id="eventTitle" name="eventTitle" required>
              <label for="eventDate">Date* :</label>
              <input type="date" id="eventDate" name="eventDate" required >
               <label for="eventOrganizer">Organized By* :</label>
              ...
              <textarea type="text" id="eventDesc" name="eventDesc" required></textarea>
