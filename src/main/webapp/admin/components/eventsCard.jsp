              ...
              <select name="course" id="courses">
               ...
               <select name="course" id="courses">
                ...
                <option value="">Faculty</option>
              	...
              	<a href="addEvents.jsp" class="btn my-3 py-3 search-btn btn-primary px-5 fs-5 w-25" type="submit">Add Event</a>
    ...
    <div class="row g-0 my-4"> <!-- Row wraps multiple cards -->
      <c:forEach var="event" items="${eventsList}">
        <div class="col-12 col-md-6 mb-4"> <!-- Full width on small screens, 50% width on larger screens -->
          <article class="event-card card fl-left me-3">
            <section class="date">
              <time datetime="23th feb">
                <img class="px-0 mx-0 w-100" src="${event.eventImg}" alt="logo">
