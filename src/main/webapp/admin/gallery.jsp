...
"${errorMsg}"
   ...
   %>
         ...
         data-url="../<%=g.getImgLink()%>" data-img-id="<%=g.getId() %>" >
                    <img src="../<%=g.getImgLink()%>" alt="">
                       <div class="user-info">
                        <img src="../alumni/<%=u.getProfile_img() %>" alt="User Profile">
           ...
           <!--  <p class="modal-desc" id="imageModalLabelDesc"></p> -->
            ...
            <hr>
              <div class="d-flex justify-content-center mb-3">
                <form action="../delete-image" method="post"  onsubmit="return confirm('Are you sure you want to delete this Image?');">
								 <input required name="id" type="hidden" id="modalImageId" class="form-control" value="">
