                ...
                <div class="card border">
                    <div class="card-body px-4">
                        <div class="flex-1 ms-1">
                            <h5 class="mb-1"><a href="#" class="text-dark"><%=j.getJobTitle() %></a></h5>
                            <span class="badge badge-soft-success mb-0 fs-5"><%=j.getCompanyName() %></span>
                            
                        </div>
                      
                        <div class="mt-2 mb-3 pt-1">
                        <div class="d-flex justify-content-around gap-2 pt-4">
                            ...
                            <p class="text-muted mb-0 fs-5"><i class='bx bx-map mx-1' ></i><%=j.getLocation() %></p>
                             ...
                             <div class="d-flex justify-content-around gap-2 pt-4">
						    <p class="text-muted mb-0 fs-5"><i class='bx bx-calendar-event mx-1'></i>Last Date: </p>
						    <p class="text-muted mb-0 fs-5"><%=j.getLastDate() %></p>
                               </div>  
                          <div class="d-flex justify-content-around gap-2 pt-4">

                            
						    <p class="text-muted mb-0 fs-5"><i class='bx bx-time mx-1'></i><%=j.getExperienceRequired() %> Years</p>
						    <p class="text-muted mb-0 fs-5"><i class='bx bxs-graduation mx-1'></i><%=j.getEligibleBatch() %> Batch</p>
                               </div>
                        </div>
                        <%
                        ...
                        <div class="d-flex align-items-center">
                            <div><img src="../alumni/<%=u.getProfile_img() %>" alt="" class="avatar-md rounded-circle img-thumbnail mx-1" /></div>
